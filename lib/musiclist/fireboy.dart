...
class Fireboy_music extends StatefulWidget {
  @override
  State<Fireboy_music> createState() => _MusicState();
}

class _MusicState extends State<Fireboy_music> {
  ...
  Future setAudio() async {
    ...
    String url =
        'https://cdn.trendybeatz.com/audio/Asake-Ft-Fireboy-DML-Bandana-(TrendyBeatz.com).mp3';
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: AssetImage('assets/fireboy.jpg'),
                        fit: BoxFit.fill)),
              )),
          Positioned(
