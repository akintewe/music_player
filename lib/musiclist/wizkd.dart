...
class Wizkid_music extends StatefulWidget {
  @override
  State<Wizkid_music> createState() => _MusicState();
}

class _MusicState extends State<Wizkid_music> {
  ...
  Future setAudio() async {
    ...
    String url =
        'https://www.xclusivepop.com/wp-content/uploads/2022/06/Chris_Brown_ft_Wizkid_-_Call_Me_Everyday.mp3';
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: AssetImage('assets/wizkid.jpg'),
                        fit: BoxFit.fill)),
              )),
          Positioned(
